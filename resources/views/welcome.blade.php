...
<!-- Mirrored from doccure-html.dreamguystech.com/template/index-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Aug 2021 14:38:17 GMT -->
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0">
    <title>Title name </title>

    <link type="image/x-icon" href="/client/assets/img/favicon.png" rel="icon">
    ...
    <link rel="stylesheet" href="/client/assets//plugins/select2/css/select2.min.css">
...
<span></span>
                        ...
                        <a href="index.html" class="navbar-brand logo">
                            <img src="client/assests/img/logo.png" class="img-fluid" alt="Logo">
                        </a>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <img src="/client/assets//img/dr-slider.png" class="img-fluid dr-img" alt="">
                </div>
                    ...
                    <div class="specialities-slider slider">
                        ...
                        <div class="speicality-item text-center">
                            <div class="speicality-img">
                                <img src="/client/assets//img/specialities/specialities-01.png" class="img-fluid" alt="Speciality"> <span><i class="fa fa-circle" aria-hidden="true"></i></span>
                            </div>
                            <p>Urology</p>
                        </div>
                        ...
                        <div class="speicality-item text-center">
                            <div class="speicality-img">
                                <img src="/client/assets//img/specialities/specialities-02.png" class="img-fluid" alt="Speciality"> <span><i class="fa fa-circle" aria-hidden="true"></i></span>
                            </div>
                            <p>Neurology</p>
                        </div>
                        ...
                        <div class="speicality-item text-center">
                            <div class="speicality-img">
                                <img src="/client/assets//img/specialities/specialities-03.png" class="img-fluid" alt="Speciality"> <span><i class="fa fa-circle" aria-hidden="true"></i></span>
                            </div>
                            <p>Orthopedic</p>
                        </div>
                        ...
                        <div class="speicality-item text-center">
                            <div class="speicality-img">
                                <img src="/client/assets//img/specialities/specialities-04.png" class="img-fluid" alt="Speciality"> <span><i class="fa fa-circle" aria-hidden="true"></i></span>
                            </div>
                            <p>Cardiologist</p>
                        </div>
                        ...
                        <div class="speicality-item text-center">
                            <div class="speicality-img">
                                <img src="/client/assets//img/specialities/specialities-05.png" class="img-fluid" alt="Speciality"> <span><i class="fa fa-circle" aria-hidden="true"></i></span>
                            </div>
                            <p>Dentist</p>
                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="category-box">
                        <div class="category-image">
                            <img src="/client/assets//img/category/1.png" alt="">
                        </div>
                ...
                <div class="col-lg-3">
                    <div class="category-box">
                        <div class="category-image">
                            <img src="/client/assets//img/category/2.png" alt="">
                        </div>
                        <div class="category-content">
                            <h4>Neurology</h4>
                ...
                <div class="col-lg-3">
                    <div class="category-box">
                        <div class="category-image">
                            <img src="/client/assets//img/category/3.png" alt="">
                        </div>
                        <div class="category-content">
                            <h4>Orthopedic</h4>
                ...
                <div class="col-lg-3">
                    <div class="category-box">
                        <div class="category-image">
                            <img src="/client/assets//img/category/4.png" alt="">
                        </div>
                        <div class="category-content">
                            <h4>Cardiologist</h4>
                ...
                <div class="col-lg-3">
                    <div class="category-box">
                        <div class="category-image">
                            <img src="/client/assets//img/category/5.png" alt="">
                        </div>
                        <div class="category-content">
                            <h4>Dentist</h4>
                ...
                <div class="col-lg-12">
                    <div class="doctor-slider slider">
                        ...
                        <div class="profile-widget">
                            <div class="doc-img">
                                <a href="doctor-profile.html">
                                    <img class="img-fluid" alt="User Image" src="/client/assets//img/doctors/doctor-01.jpg">
                                </a>
                        ...
                        <div class="profile-widget">
                            <div class="doc-img">
                                <a href="doctor-profile.html">
                                    <img class="img-fluid" alt="User Image" src="/client/assets//img/doctors/doctor-02.jpg">
                                </a>
                                <a href="javascript:void(0)" class="fav-btn"> <i class="far fa-bookmark"></i>
                                </a>
                            </div>
                        ...
                        <div class="profile-widget">
                            <div class="doc-img">
                                <a href="doctor-profile.html">
                                    <img class="img-fluid" alt="User Image" src="/client/assets//img/doctors/doctor-03.jpg">
                                </a>
                                <a href="javascript:void(0)" class="fav-btn"> <i class="far fa-bookmark"></i>
                                </a>
                            </div>
                        ...
                        <div class="profile-widget">
                            <div class="doc-img">
                                <a href="doctor-profile.html">
                                    <img class="img-fluid" alt="User Image" src="/client/assets//img/doctors/doctor-04.jpg">
                                </a>
                                <a href="javascript:void(0)" class="fav-btn"> <i class="far fa-bookmark"></i>
                                </a>
                            </div>
                        ...
                        <div class="profile-widget">
                            <div class="doc-img">
                                <a href="doctor-profile.html">
                                    <img class="img-fluid" alt="User Image" src="/client/assets//img/doctors/doctor-05.jpg">
                                </a>
                                <a href="javascript:void(0)" class="fav-btn"> <i class="far fa-bookmark"></i>
                                </a>
                            </div>
                        ...
                        <div class="profile-widget">
                            <div class="doc-img">
                                <a href="doctor-profile.html">
                                    <img class="img-fluid" alt="User Image" src="/client/assets//img/doctors/doctor-06.jpg">
                                </a>
                                <a href="javascript:void(0)" class="fav-btn"> <i class="far fa-bookmark"></i>
                                </a>
                            </div>
                        ...
                        <div class="profile-widget">
                            <div class="doc-img">
                                <a href="doctor-profile.html">
                                    <img class="img-fluid" alt="User Image" src="/client/assets//img/doctors/doctor-07.jpg">
                                </a>
                                <a href="javascript:void(0)" class="fav-btn"> <i class="far fa-bookmark"></i>
                                </a>
                            </div>
                        ...
                        <div class="profile-widget">
                            <div class="doc-img">
                                <a href="doctor-profile.html">
                                    <img class="img-fluid" alt="User Image" src="/client/assets//img/doctors/doctor-08.jpg">
                                </a>
                                <a href="javascript:void(0)" class="fav-btn"> <i class="far fa-bookmark"></i>
                                </a>
                            </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-5 features-img">
                    <img src="/client/assets//img/features/feature.png" class="img-fluid" alt="Feature">
                </div>
                <div class="col-md-7">
                    ...
                    <div class="features-slider slider">
                        ...
                        <div class="feature-item text-center">
                            <img src="/client/assets//img/features/feature-01.jpg" class="img-fluid" alt="Feature">
                            <p>Patient Ward</p>
                        </div>


                        <div class="feature-item text-center">
                            <img src="/client/assets//img/features/feature-02.jpg" class="img-fluid" alt="Feature">
                            <p>Test Room</p>
                        </div>


                        <div class="feature-item text-center">
                            <img src="/client/assets//img/features/feature-03.jpg" class="img-fluid" alt="Feature">
                            <p>ICU</p>
                        </div>


                        <div class="feature-item text-center">
                            <img src="/client/assets//img/features/feature-04.jpg" class="img-fluid" alt="Feature">
                            <p>Laboratory</p>
                        </div>


                        <div class="feature-item text-center">
                            <img src="/client/assets//img/features/feature-05.jpg" class="img-fluid" alt="Feature">
                            <p>Operation</p>
                        </div>


                        <div class="feature-item text-center">
                            <img src="/client/assets//img/features/feature-06.jpg" class="img-fluid" alt="Feature">
                            <p>Medical</p>
                        </div>
            ...
            <div class="row blog-grid-row">
                    ...
                    <div class="blog grid-blog">
                        <div class="blog-image">
                            <a href="blog-details.html">
                                <img class="img-fluid" src="/client/assets//img/blog/blog-01.jpg" alt="Post Image">
                            </a>
                        </div>
                            ...
                            <ul class="entry-meta meta-item">
                                <li>
                                    <div class="post-author">
                                        <a href="doctor-profile.html">
                                            <img src="/client/assets//img/doctors/doctor-thumb-01.jpg" alt="Post Author"> <span>Dr. Ruby Perrin</span>
                                        </a>
                                    </div>
                                </li>
                ...
                <div class="col-md-6 col-lg-3 col-sm-12">
                    ...
                    <div class="blog grid-blog">
                        <div class="blog-image">
                            <a href="blog-details.html">
                                <img class="img-fluid" src="/client/assets//img/blog/blog-02.jpg" alt="Post Image">
                            </a>
                        </div>
                        <div class="blog-content">
                            <ul class="entry-meta meta-item">
                                <li>
                                    <div class="post-author">
                                        <a href="doctor-profile.html">
                                            <img src="/client/assets//img/doctors/doctor-thumb-02.jpg" alt="Post Author"> <span>Dr. Darren Elder</span>
                                        </a>
                                    </div>
                                </li>
                ...
                <div class="col-md-6 col-lg-3 col-sm-12">
                    ...
                    <div class="blog grid-blog">
                        <div class="blog-image">
                            <a href="blog-details.html">
                                <img class="img-fluid" src="/client/assets//img/blog/blog-03.jpg" alt="Post Image">
                            </a>
                        </div>
                        <div class="blog-content">
                            <ul class="entry-meta meta-item">
                                <li>
                                    <div class="post-author">
                                        <a href="doctor-profile.html">
                                            <img src="/client/assets//img/doctors/doctor-thumb-03.jpg" alt="Post Author"> <span>Dr. Deborah Angel</span>
                                        </a>
                                    </div>
                                </li>
                                <li><i class="far fa-clock"></i> 3 Dec 2019</li>
                ...
                <div class="col-md-6 col-lg-3 col-sm-12">
                    ...
                    <div class="blog grid-blog">
                        <div class="blog-image">
                            <a href="blog-details.html">
                                <img class="img-fluid" src="/client/assets//img/blog/blog-04.jpg" alt="Post Image">
                            </a>
                        </div>
                        <div class="blog-content">
                            <ul class="entry-meta meta-item">
                                <li>
                                    <div class="post-author">
                                        <a href="doctor-profile.html">
                                            <img src="/client/assets//img/doctors/doctor-thumb-04.jpg" alt="Post Author"> <span>Dr. Sofia Brient</span>
                                        </a>
                                    </div>
                                </li>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="footer-widget footer-about">
                            <div class="footer-logo">
                                <img src="/client/assets//img/footer-logo.png" alt="logo">
                            </div>
                        ...
                        <div class="footer-widget footer-contact">
                            ...
                            <div class="footer-contact-info">
                                ...
                                <p class="mb-0"> <i class="fas fa-envelope"></i>
                                    <a href="https://doccure-html.dreamguystech.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="b9ddd6dadacccbdcf9dcc1d8d4c9d5dc97dad6d4">[email&#160;protected]</a></p>
                            </div>
                        </div>
...
<script data-cfasync="false" src="../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="/client/assets//js/jquery.min.js"></script>
...
<!-- Mirrored from doccure-html.dreamguystech.com/template/index-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Aug 2021 14:38:20 GMT -->
</html>
